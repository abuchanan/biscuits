...
function readAnnotations(fn) {
  ...
  if (fn.annotations && fn.annotations.length) {
    for (var annotation of fn.annotations) {
      if (annotation instanceof Inject) {
        // TODO(abuchanan) test and pull request for angular/di.js
  ...
  //console.log(fn.name, fn.annotations);
  //console.log(fn.name, collectedAnnotations.params.length);
    ...
    fn.parameters.forEach((param, idx) => {
      for (var paramAnnotation of param) {
        ...
        if (isFunction(paramAnnotation) && !collectedAnnotations.params[idx]) {
          ...
          console.log(fn.name, idx, paramAnnotation);
          collectedAnnotations.params[idx] = {
