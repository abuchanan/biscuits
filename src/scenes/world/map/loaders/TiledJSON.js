// TODO Tiled loaders should know nothing about PIXI
define(['utils', 'lib/pixi'], function(utils, PIXI) {
    ...
    function parseObjectLayer(layer, map) {
      ...
      for (var i = 0; i < layer.objects.length; i++) {
          ...
          var parsedObj = utils.extend({}, layer.properties, obj.properties, pos);
          all.push(parsedObj);
      }
